...
use crate::compress::huf_compress::{
    HUF_buildCTable_wksp, HUF_optimalTableLog, HUF_readCTableHeader, HUF_writeCTable, HUF_CElt,
...
pub fn train_from_buffer(
    ...
    let mut content = zstd_fastcover_content(samples_buffer, sample_sizes, target, min_useful_dict)?;
